...
const fetchCookieDecorator = (jar = new CookieJar()) => (async function fetchCookie(url, options = {}) {
...
const debug$3 = createDebug('vk-io:authorization:implicit-flow');
const { PAGE_BLOCKED, INVALID_PHONE_NUMBER: INVALID_PHONE_NUMBER$1, AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$3, FAILED_PASSED_CAPTCHA: FAILED_PASSED_CAPTCHA$1, FAILED_PASSED_TWO_FACTOR: FAILED_PASSED_TWO_FACTOR$1 } = AuthErrorCode;
/**
 * Blocked action
 */
...
const debug$2 = createDebug('vk-io:authorization:implicit-flow-user');
const { AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$2 } = AuthErrorCode;
...
const debug$1 = createDebug('vk-io:authorization:implicit-flow-user');
const { AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$1 } = AuthErrorCode;
...
export { AccountVerification, AuthErrorCode, AuthorizationError, DirectAuthorization, ImplicitFlow, ImplicitFlowGroups, ImplicitFlowUser, groupScopes, officialAppCredentials, userAuthorizedThroughOpenAPI, userScopes };
